...
output:
  rmarkdown::html_vignette:
    ...
    toc_depth: 4
description: >
    Provides an overview of reference semantics in {container}, where
    operations like ref_add() modify objects directly. While potentially
    useful for optimizing performance or reducing code verbosity, this
    vignette advises cautious use to avoid unnecessary coupling or
