describe("Ops compare", {
    describe("Container", {
        test_that("comparison operations work for Container objects", {
            # Simple elements
            co1 <- container(1)
            co2 <- container(2)
            co3 <- container(3)
    ...
    describe("Set", {
        test_that("comparison operations work for Set objects", {
            # simple sets
            x <- setnew(1, 2,    "1", "2")
            y <- setnew(   2, 3,      "2", "3")
    ...
    describe("Relational", {
        test_that("relational operations work correctly", {
            s0   <- setnew()
            s1   <- setnew(1)
            s12  <- setnew(1, 2)
            s23  <- setnew(   2, 3)
