describe("Set S3 methods", {
    ee <- expect_equal

    describe("setnew", {
        test_that("setnew creates sets correctly", {
            s <- setnew()
    ...
    describe("as.set", {
        test_that("as.set converts objects to sets", {
    ...
    describe("is.set", {
        test_that("is.set identifies sets correctly", {
            expect_error(is.set())
    ...
    describe("c.Set", {
        test_that("c.Set concatenates sets correctly (non-recursive)", {
        ...
        test_that("c.Set concatenates sets correctly (recursive)", {
            # recursive
        ...
        test_that("concatenated objects are always copies", {
    ...
    describe("OrderedSet", {
        test_that("OrderedSet works correctly", {
