...
## ----benchmark1, warning = FALSE, message = FALSE, cache=cacheBenchmarks, fig.alt="Benchmark1"----
...
sbm <- summary(bm)
rownames(sbm) <- sbm[, "expr"]
ratio <- sbm["dplyr", "median"] / sbm["dict.table", "median"]

## ----benchmark2, warning = FALSE, message = FALSE, cache=cacheBenchmarks, fig.alt="Benchmark2"----
data = cars
bm <- microbenchmark(control = list(order="inorder"), times = 100,
...
## ----benchmark3, warning = FALSE, message = FALSE, cache=cacheBenchmarks, fig.alt="Benchmark3"----
data = cars
bm <- microbenchmark(control = list(order="inorder"), times = 100,
